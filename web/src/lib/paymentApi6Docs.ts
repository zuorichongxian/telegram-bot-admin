...
export const payment6InterfaceRules = [
...
export const payment6OrderStates = [
  { code: 0, desc: "待支付" },
  { code: 1, desc: "支付成功" },
  { code: 2, desc: "支付失败" },
  { code: 3, desc: "未出码" },
...
export const payment6SignRules = [
...
export const payment6ApiDocs: ApiDocInterface[] = [
  {
    name: "统一下单",
    url: "https://jkapi-wansheng.douyaya.com/api/v1/pay/unifiedOrder",
    method: "POST",
    description: "发起支付收款订单，网关返回支付地址给商户展示。",
    request: {
      title: "请求参数",
      params: [
        { fieldName: "商户号", variableName: "mchId", required: true, type: "string", example: "1011", description: "商户号" },
        ...
        ,
        { fieldName: "商户秘钥", variableName: "key", required: true, type: "string", example: "jkkGqwL7SbpRMZ7cviD8oZn", description: "请求体附带的 key 参数" }
      ]
    },
    response: {
      title: "返回参数",
  ...
  {
    name: "查询订单",
    url: "https://jkapi-wansheng.douyaya.com/api/v1/pay/queryOrder",
    method: "POST",
  ...
  {
    name: "余额查询",
    url: "https://jkapi-wansheng.douyaya.com/api/v1/merchant/queryBalance",
    method: "POST",
