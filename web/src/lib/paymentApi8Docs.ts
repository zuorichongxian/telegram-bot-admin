...
export const payment8InterfaceRules = [
...
export const payment8OrderStates = [
  { code: 0, desc: "待支付" },
  { code: 1, desc: "支付成功" },
  { code: 2, desc: "支付失败" },
  { code: 3, desc: "未出码" },
...
export const payment8SignRules = [
...
export const payment8ApiDocs: ApiDocInterface[] = [
  {
    name: "统一下单",
    url: "http://cdnapi.hnqo.xyz/Pay_Index.html?pay_format=json",
    method: "POST",
    description: "发起支付收款订单，网关返回支付地址给商户展示。",
    request: {
      title: "请求参数",
      params: [
        { fieldName: "商户号", variableName: "mch_id", required: true, type: "string", example: "260505221", description: "商务号" },
        { fieldName: "通道类型", variableName: "pay_type", required: true, type: "string", example: "wxpay", description: "支付通道编码" },
        { fieldName: "商户订单号", variableName: "out_trade_no", required: true, type: "string", example: "FX20260101001", description: "商户系统生成的唯一订单号" },
        { fieldName: "支付金额", variableName: "order_amount", required: true, type: "string", example: "100.00", description: "单位为元，精确到小数点后2位" },
    ...
    dataResponse: {
      title: "data 结构",
      params: [
        { fieldName: "商户号", variableName: "mch_id", required: true, type: "string", example: "260505221", description: "商户号" },
  ...
  {
    name: "查询订单",
    url: "http://cdnapi.hnqo.xyz/Pay_Trade_query.html",
    method: "POST",
